...
.method public build()Ljavax/net/ssl/SSLContext;
    ...
    :goto_1
    iget-object v2, p0, Lcz/msebera/android/httpclient/ssl/SSLContextBuilder;->keyManagers:Ljava/util/Set;

    iget-object v3, p0, Lcz/msebera/android/httpclient/ssl/SSLContextBuilder;->trustManagers:Ljava/util/Set;

    iget-object v4, p0, Lcz/msebera/android/httpclient/ssl/SSLContextBuilder;->secureRandom:Ljava/security/SecureRandom;

    invoke-virtual {p0, v1, v2, v3, v4}, Lcz/msebera/android/httpclient/ssl/SSLContextBuilder;->initSSLContext(Ljavax/net/ssl/SSLContext;Ljava/util/Collection;Ljava/util/Collection;Ljava/security/SecureRandom;)V
...
.method public loadKeyMaterial(Ljava/security/KeyStore;[CLcz/msebera/android/httpclient/ssl/PrivateKeyStrategy;)Lcz/msebera/android/httpclient/ssl/SSLContextBuilder;
    ...
    invoke-direct {v4, v5, p3}, Lcz/msebera/android/httpclient/ssl/SSLContextBuilder$KeyManagerDelegate;-><init>(Ljavax/net/ssl/X509ExtendedKeyManager;Lcz/msebera/android/httpclient/ssl/PrivateKeyStrategy;)V
    ...
    .line 314
    .local v4, "km":Ljavax/net/ssl/KeyManager;
    iget-object v5, p0, Lcz/msebera/android/httpclient/ssl/SSLContextBuilder;->keyManagers:Ljava/util/Set;

    invoke-interface {v5, v4}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    .line 313
    .end local v4    # "km":Ljavax/net/ssl/KeyManager;
...
.method public loadTrustMaterial(Ljava/security/KeyStore;Lcz/msebera/android/httpclient/ssl/TrustStrategy;)Lcz/msebera/android/httpclient/ssl/SSLContextBuilder;
    ...
    invoke-direct {v4, v5, p2}, Lcz/msebera/android/httpclient/ssl/SSLContextBuilder$TrustManagerDelegate;-><init>(Ljavax/net/ssl/X509TrustManager;Lcz/msebera/android/httpclient/ssl/TrustStrategy;)V
    ...
    iget-object v5, p0, Lcz/msebera/android/httpclient/ssl/SSLContextBuilder;->trustManagers:Ljava/util/Set;
...
.method public setProvider(Ljava/lang/String;)Lcz/msebera/android/httpclient/ssl/SSLContextBuilder;
    ...
    iput-object v0, p0, Lcz/msebera/android/httpclient/ssl/SSLContextBuilder;->provider:Ljava/security/Provider;
