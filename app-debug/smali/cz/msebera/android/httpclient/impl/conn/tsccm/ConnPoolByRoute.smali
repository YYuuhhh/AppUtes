...
.method public closeExpiredConnections()V
    ...
    .line 750
    .local v2, "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;>;"
    :goto_0
    ...
    .line 761
    .end local v2    # "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;>;"
    :cond_2
    iget-object v2, p0, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;
...
.method public closeIdleConnections(JLjava/util/concurrent/TimeUnit;)V
    ...
    .line 727
    .local v4, "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;>;"
    :goto_0
    ...
    check-cast v5, Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;

    .line 729
    .local v5, "entry":Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    invoke-virtual {v5}, Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;->getUpdated()J
    ...
    .line 734
    invoke-virtual {p0, v5}, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->deleteEntry(Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 736
    .end local v5    # "entry":Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    :cond_3
    goto :goto_0

    .line 738
    .end local v4    # "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;>;"
    :cond_4
    iget-object v4, p0, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;
...
.method protected deleteEntry(Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;)V
    ...
    .line 593
    .local v2, "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    ...
    .line 600
    .end local v2    # "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    :cond_1
    iget-object v1, p0, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;
...
.method public freeEntry(Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;ZJLjava/util/concurrent/TimeUnit;)V
    ...
    .line 449
    .local v3, "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    if-eqz p2, :cond_4
    ...
    .line 472
    .end local v3    # "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    iget-object v1, p0, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;
...
.method public getConnectionsInPool(Lcz/msebera/android/httpclient/conn/routing/HttpRoute;)I
    ...
    invoke-virtual {v1}, Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;->getEntryCount()I
    ...
    .line 263
    .end local v1    # "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    :catchall_0
    move-exception v0
...
.method protected getEntryBlocking(Lcz/msebera/android/httpclient/conn/routing/HttpRoute;Ljava/lang/Object;JLjava/util/concurrent/TimeUnit;Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThreadAborter;)Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    ...
    .line 337
    .local v7, "entry":Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    iget-object v0, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;
    ...
    :try_start_0
    invoke-virtual {v1, v2, v0}, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->getRoutePool(Lcz/msebera/android/httpclient/conn/routing/HttpRoute;Z)Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;

    move-result-object v8

    .line 341
    .local v8, "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    const/4 v10, 0x0

    .line 343
    .local v10, "waitingThread":Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;
    :goto_1
    if-nez v7, :cond_c

    .line 344
    iget-boolean v11, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->shutdown:Z
    ...
    invoke-static {v11, v13}, Lcz/msebera/android/httpclient/util/Asserts;->check(ZLjava/lang/String;)V

    .line 346
    iget-object v11, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->log:Lcz/msebera/android/httpclient/extras/HttpClientAndroidLog;
    ...
    iget-object v15, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->freeConnections:Ljava/util/Queue;
    ...
    iget-object v15, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->leasedConnections:Ljava/util/Set;
    ...
    iget v15, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->numConnections:I
    ...
    iget v15, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->maxTotalConnections:I
    ...
    .line 347
    invoke-virtual {v11, v14}, Lcz/msebera/android/httpclient/extras/HttpClientAndroidLog;->debug(Ljava/lang/Object;)V

    .line 358
    :cond_2
    invoke-virtual {v1, v8, v3}, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->getFreeEntry(Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;Ljava/lang/Object;)Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    ...
    .line 363
    :cond_3
    invoke-virtual {v8}, Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;->getCapacity()I
    ...
    iget-object v12, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->log:Lcz/msebera/android/httpclient/extras/HttpClientAndroidLog;
    ...
    .line 367
    invoke-virtual {v8}, Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;->getMaxEntries()I
    ...
    .line 366
    invoke-virtual {v12, v0}, Lcz/msebera/android/httpclient/extras/HttpClientAndroidLog;->debug(Ljava/lang/Object;)V

    .line 371
    :cond_5
    if-eqz v11, :cond_6

    iget v0, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->numConnections:I

    iget v4, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->maxTotalConnections:I

    if-ge v0, v4, :cond_6

    .line 373
    iget-object v0, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->operator:Lcz/msebera/android/httpclient/conn/ClientConnectionOperator;

    invoke-virtual {v1, v8, v0}, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->createEntry(Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;Lcz/msebera/android/httpclient/conn/ClientConnectionOperator;)Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    ...
    .end local v7    # "entry":Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    .local v0, "entry":Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    goto/16 :goto_4

    .line 375
    .end local v0    # "entry":Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    .restart local v7    # "entry":Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    :cond_6
    if-eqz v11, :cond_7

    iget-object v0, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->freeConnections:Ljava/util/Queue;
    ...
    .line 377
    invoke-virtual/range {p0 .. p0}, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->deleteLeastUsedEntry()V
    ...
    .line 381
    .end local v8    # "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    .local v4, "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    iget-object v5, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->operator:Lcz/msebera/android/httpclient/conn/ClientConnectionOperator;

    invoke-virtual {v1, v4, v5}, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->createEntry(Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;Lcz/msebera/android/httpclient/conn/ClientConnectionOperator;)Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    ...
    .end local v5    # "entry":Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    .restart local v7    # "entry":Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    .restart local v8    # "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    :cond_7
    const/4 v0, 0x1

    .line 385
    iget-object v4, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->log:Lcz/msebera/android/httpclient/extras/HttpClientAndroidLog;
    ...
    .line 391
    iget-object v4, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;
    ...
    invoke-virtual {v1, v4, v8}, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->newWaitingThread(Ljava/util/concurrent/locks/Condition;Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;)Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;
    ...
    :try_start_3
    invoke-virtual {v4, v10}, Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThreadAborter;->setWaitingThread(Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;)V
    :try_end_3
    ...
    .line 421
    .end local v8    # "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    .end local v10    # "waitingThread":Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;
    ...
    .line 390
    .restart local v8    # "rospl":Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    .restart local v10    # "waitingThread":Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;
    ...
    .local v5, "success":Z
    :try_start_4
    invoke-virtual {v8, v10}, Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;->queueThread(Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;)V

    .line 399
    iget-object v12, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->waitingThreads:Ljava/util/Queue;

    invoke-interface {v12, v10}, Ljava/util/Queue;->add(Ljava/lang/Object;)Z

    .line 400
    invoke-virtual {v10, v6}, Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;->await(Ljava/util/Date;)Z
    ...
    .line 407
    :try_start_5
    invoke-virtual {v8, v10}, Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;->removeThread(Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;)V
    ...
    invoke-direct {v0, v12}, Lcz/msebera/android/httpclient/conn/ConnectionPoolTimeoutException;-><init>(Ljava/lang/String;)V
    ...
    .end local p6    # "aborter":Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThreadAborter;
    throw v0
    ...
    .restart local p6    # "aborter":Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThreadAborter;
    :cond_b
    :goto_4
    move-wide/from16 v4, p3
    ...
    :goto_6
    iget-object v5, v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;
...
.method protected getFreeEntry(Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;Ljava/lang/Object;)Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;
    ...
    invoke-virtual {v0, v4, v5}, Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;->isExpired(J)Z
...
.method protected getRoutePool(Lcz/msebera/android/httpclient/conn/routing/HttpRoute;Z)Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
    ...
    check-cast v1, Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;
...
.method protected notifyWaitingThread(Lcz/msebera/android/httpclient/impl/conn/tsccm/RouteSpecificPool;)V
    ...
    .line 663
    .local v0, "waitingThread":Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;
    iget-object v1, p0, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;
    ...
    .line 672
    :cond_1
    iget-object v1, p0, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->waitingThreads:Ljava/util/Queue;
    ...
    .line 682
    invoke-virtual {v0}, Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;->wakeup()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public shutdown()V
    ...
    .line 776
    .local v0, "iter1":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;>;"
    :goto_0
    invoke-interface {v0}, Ljava/util/Iterator;->hasNext()Z
    ...
    .line 784
    .local v1, "iter2":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;>;"
    :goto_1
    ...
    .line 790
    invoke-virtual {v2}, Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;->getPlannedRoute()Lcz/msebera/android/httpclient/conn/routing/HttpRoute;
    ...
    invoke-virtual {v2}, Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;->getState()Ljava/lang/Object;
    ...
    .line 797
    .local v2, "iwth":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;>;"
    :goto_2
    invoke-interface {v2}, Ljava/util/Iterator;->hasNext()Z
    ...
    check-cast v3, Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;

    .line 799
    .local v3, "waiter":Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;
    invoke-interface {v2}, Ljava/util/Iterator;->remove()V

    .line 800
    invoke-virtual {v3}, Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;->wakeup()V

    .line 801
    .end local v3    # "waiter":Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;
    goto :goto_2

    .line 803
    :cond_4
    iget-object v3, p0, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->routeToPool:Ljava/util/Map;
    ...
    .line 806
    .end local v0    # "iter1":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;>;"
    .end local v1    # "iter2":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/impl/conn/tsccm/BasicPoolEntry;>;"
    .end local v2    # "iwth":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcz/msebera/android/httpclient/impl/conn/tsccm/WaitingThread;>;"
    iget-object v0, p0, Lcz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;
